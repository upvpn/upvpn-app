...
use upvpn_types::{
    ...
    upvpn_server::{ClientConnected, EndSession, NewSession, UserCredentials, VpnSessionStatus},
...
impl Daemon {
    ...
    async fn set_vpn_status(&mut self, vpn_status: upvpn_types::vpn_session::VpnStatus) {
        // save current state
    ...
    async fn on_connect(
        ...
        location: upvpn_types::location::Location,
    ) {
